...
const SearchPage = ({
  ...
  totalPages, hasMore, currentPage, setCurrentPage, setIsBlogPopupOpen, setCurrentBlog,
}) => {
  ...
  return (<div className="max-w-grid p-grid mt-20 md:w-screen text-black dark:text-white min-h-[250vh]">
    ...
    rates={rates} currencyValue={currencyValue} setCurrencyValue={setCurrencyValue} totalPages={totalPages} hasMore={hasMore} currentPage={currentPage} />
  </div>
  );
};
