...
const SearchPage = ({
  ...
  searchDropdownValue, setVidDis, setCurrentVid, setActiveVidIndex, trendingData, tagsData, weather, dailyNews, rates, totalPages, currentPage, setCurrentPage
}) => {
  ...
  return (<div className="max-w-grid p-grid mt-20 md:w-screen text-black dark:text-white min-h-[250vh]">
    ...
    setCurrentVid={setCurrentVid} setActiveVidIndex={setActiveVidIndex}
