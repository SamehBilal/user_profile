...
function SideMenu() {
  ...
  return (
    <div className='max-xl:hidden fixed lrt:left-10 rtl:right-10 top-40 bottom-12 w-1/5 flex flex-col items-start justify-between text-primary dark:text-primaryLight z-10 bg-white dark:bg-darkGray'>
      <MenuList />
