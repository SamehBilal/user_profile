  ...
  return (
    <nav className="text-black dark:text-white shadow-md dark:shadow-gray-300/20 w-screen flex justify-between items-center mx-auto px-8 py-2 absolute top-0 right-0 left-0 ">
      ...
      <div className="flex gap-2 items-center justify-center flex-grow">
        ...
        <input className="border-l flex-grow p-2 border-gray-300 bg-transparent text-sm pl-4 placeholder:text-black dark:text-white placeholder:font-light focus-visible:border-primary focus-visible:!ring-primary focus:border-primary focus:!ring-primary" 
        type="text"
      ...
      <div className="flex flex-col justify-center items-between">
        ...
        <div className={`max-h-44 flex justify-center items-center gap-4 absolute right-48 top-12 p-4 bg-gray-200 rounded-lg ${dropdownPopoverShow?'':'hidden'}`}>
